      ...
      <main className="flex-grow mt-16">
        ...
        <section id="about" className="p-8 bg-white shadow-md">
          ...
          <h2 className="text-3xl font-bold mb-4">About Me</h2>
              <p className="text-2xl font-bold mb-2">Abu Taher Md. Shahin</p>
              <p className="text-2xl mb-2">Front End Web Developer</p>
              <p className="mb-2">Malibagh, Dhaka</p>
              <p>
        ...
        <section id="resume" className="p-8 bg-gray-100">
          ...
          download className="text-blue-500 underline">Download Resume</a>
        </section>
